            ...
            <div className="min-h-screen p-6">
                <Container>
                    <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div>
                            <h1 className="text-2xl md:text-3xl font-bold text-secondary mb-2">Administradores</h1>
                            <p className="text-sm md:text-base text-secondary70">Gerencie as contas de administradores do sistema</p>
                        </div>
                        <Button
                            onClick={() => {
                                reset();
                        ...
                        >
                            <tbody>
                                {admins.data?.map((admin, index) => (
                                    ...
                                    >
                                        <td className="px-2 md:px-4 py-2 md:py-4 font-medium">{admin.name}</td>
                                        <td className="px-2 md:px-4 py-2 md:py-4">{admin.email}</td>
